...
def main(config_path):
    ...
    max_len = datamodule.train_set.get_max_seqlen()+2
    ...
    wandb_logger = WandbLogger(project='SMT_Reimplementation', group="GrandStaff", name="SMT 0.25 firsthalf", log_model=False)
